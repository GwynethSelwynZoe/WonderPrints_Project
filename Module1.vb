    ...
    Sub Read_InvoiceManagement()
        Using conn As New MySqlConnection("host=127.0.0.1;database=databasefundamentalproject;username=root;password=")
            Try
                ...
                ds = New DataSet
                dataAdapter.Fill(ds, "databasefundamentalproject")
                InvoiceManagement.DGInvoice.DataSource = ds
                InvoiceManagement.DGInvoice.DataMember = "databasefundamentalproject"
            Catch ex As Exception
                MessageBox.Show("Error:" & ex.Message)
            End Try
        End Using
    ...
    Sub ShowProducts()
        Using conn As New MySqlConnection("host=127.0.0.1;database=databasefundamentalproject;username=root;password=")
            Try
                ...
                InventoryManagement.DGPname.DataMember = "databasefundamentalproject"
            Catch ex As Exception
                MessageBox.Show("Error:" & ex.Message)
            End Try
        End Using
    ...
    Sub ShowMyOrders()
        Using conn As New MySqlConnection("host=127.0.0.1;database=databasefundamentalproject;username=root;password=")
            Try
                ...
                Dashboard.DGMyOrders.DataMember = "databasefundamentalproject"
            Catch ex As Exception
                MessageBox.Show("Error:" & ex.Message)
            End Try
        End Using
