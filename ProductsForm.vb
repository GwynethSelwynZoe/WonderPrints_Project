Public Class ProductsForm
    ...
    'Private Sub ProductsForm_Load(sender As Object, e As EventArgs)
    ...
    Private Sub PackageAddToCart_Click(sender As Object, e As EventArgs) Handles PackageAddToCart.Click
        Try
            ...
            Dim tPrice As Decimal = quantity * productCost1
            ...
            Cart.DGCart.Rows(rowIndex).Cells(5).Value = tPrice
